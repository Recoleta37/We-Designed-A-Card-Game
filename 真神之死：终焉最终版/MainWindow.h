...
private:
    ...
    QWidget* titleOverlay = nullptr;
    QLabel* titleBackgroundLabel = nullptr;
    QLabel* titleMainLabel = nullptr;
    std::array<QLabel*, 4> titleKeywordLabels{};
    QLabel* titleQuestionLabel = nullptr;
    QPushButton* titleStartButton = nullptr;
    QPixmap titleBackgroundPixmap;
    ...
    void updateTitleOverlayGeometry();
    void fadeInTitleWidget(QWidget* widget, int durationMs);
